package com.moon._sb0419.controller;

import com.moon._sb0419.entity.Notice;
import com.moon._sb0419.repository.NoticeRepository;
import com.moon._sb0419.service.DetailService;
import com.moon._sb0419.service.NoticeService;
...
public class MyController {
    ...
    public String listAction(Model model, @PageableDefault(page = 0, size = 10) Pageable pageable){
        ...
        final int start = (int) pageable.getOffset(); //offset을 계산해 시작 페이지를 설정해줌
